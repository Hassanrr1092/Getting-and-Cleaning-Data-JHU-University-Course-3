...
Note: from several csv files related to the questions, as a sample of my work, I uploaded the messiest data set "GDP.csv" and its cleaned version I worked on. 
